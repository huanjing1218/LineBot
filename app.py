...
machine = TocMachine(
    states=["user", "weather_service", "check_weather", "weather", "check_forecast", "weather_forecast", "radar_echo"],
    transitions=[
        {
            "trigger": "advance",
            "source": "user",
        ...
        {"trigger": "go_back", "source": ["weather", "weather_forecast", "radar_echo"], "dest": "user"},
    ],
    initial="user",
